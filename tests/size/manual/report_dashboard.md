...
1. Run `python reports/size/update.py --input output/sandbox/wasm/debug --output sandbox/wasm/debug` to refresh manifest data.
...
1. From terminal, run `python reports/size/update.py --input output/sandbox/wasm/debug --output sandbox/wasm/debug`.
...
1. Run the update script for both debug and release folders:
   ...
   - `python reports/size/update.py --input output/sandbox/wasm/release --output sandbox/wasm/release`
