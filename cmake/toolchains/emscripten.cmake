...
if(WIN32)
    ...
    set(_EMAR_PATH "${EMSCRIPTEN_ROOT}/emar.bat")
    set(_EMRANLIB_PATH "${EMSCRIPTEN_ROOT}/emranlib.bat")
else()
    set(_EMCC_PATH "${EMSCRIPTEN_ROOT}/emcc")
    set(_EMXX_PATH "${EMSCRIPTEN_ROOT}/em++")
    set(_EMAR_PATH "${EMSCRIPTEN_ROOT}/emar")
    set(_EMRANLIB_PATH "${EMSCRIPTEN_ROOT}/emranlib")
endif()

foreach(_tool IN ITEMS _EMCC_PATH _EMXX_PATH _EMAR_PATH _EMRANLIB_PATH)
    if(NOT EXISTS "${${_tool}}")
        message(FATAL_ERROR "${_tool} not found at ${${_tool}}")
    endif()
endforeach()

set(CMAKE_C_COMPILER   "${_EMCC_PATH}")
set(CMAKE_CXX_COMPILER "${_EMXX_PATH}")
set(CMAKE_AR "${_EMAR_PATH}" CACHE FILEPATH "Archiver for Emscripten" FORCE)
set(CMAKE_RANLIB "${_EMRANLIB_PATH}" CACHE FILEPATH "ranlib for Emscripten" FORCE)
set(CMAKE_C_COMPILER_AR "${_EMAR_PATH}" CACHE FILEPATH "C archiver for Emscripten" FORCE)
set(CMAKE_CXX_COMPILER_AR "${_EMAR_PATH}" CACHE FILEPATH "C++ archiver for Emscripten" FORCE)
set(CMAKE_C_COMPILER_RANLIB "${_EMRANLIB_PATH}" CACHE FILEPATH "C ranlib for Emscripten" FORCE)
set(CMAKE_CXX_COMPILER_RANLIB "${_EMRANLIB_PATH}" CACHE FILEPATH "C++ ranlib for Emscripten" FORCE)
...
set(WEB_JS_CLOSURE_LEVEL "1" CACHE STRING "Closure compiler level for emitted JavaScript (empty disables)")
...
set(_NT_DEBUG_LINK_FLAGS          "-g -sASSERTIONS=2 -sSTACK_OVERFLOW_CHECK=2 --profiling-funcs")
...
if(NOT "${WEB_JS_CLOSURE_LEVEL}" STREQUAL "")
    string(APPEND _NT_RELEASE_LINK_FLAGS " --closure=${WEB_JS_CLOSURE_LEVEL}")
endif()
